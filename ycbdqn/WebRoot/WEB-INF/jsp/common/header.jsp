			...
			<div class="col-md-3 left_col menu_fixed">
				<div class="left_col scroll-view">
					<div class="navbar nav_title" style="border: 0;">
						<a href="${pageContext.request.contextPath }/dev/flatform/main" class="site_title"><i class="fa fa-paw"></i> <span>ycbdqn
								BMS</span>
						</a>
					</div>
						...
						<div class="menu_section">
							...
							<ul class="nav side-menu">
								...
								<li><a><i class="fa fa-edit"></i> 校园管理<span
									...
									<ul class="nav child_menu">
										<li><a href="${pageContext.request.contextPath }/CustomerCard/sys/customer_card.html">客户体验卡维护</a>
										</li>
										<li><a href="${pageContext.request.contextPath }/CampusInformation/sys/list">校园资讯维护</a>
										</li>
										<li><a href="${pageContext.request.contextPath }/empStar/sys/list">就业明星维护</a>
										</li>
										<li><a href="${pageContext.request.contextPath }/school/sys/list">校园环境维护</a>
										</li>
										<li><a href="${pageContext.request.contextPath }/schoollife/sys/schoollifelist.html">校园生活维护</a>
										</li>
										<li><a href="${pageContext.request.contextPath }/teacher/sys/teacherList.html">师资维护</a>
										</li>
									</ul></li>
							</ul>
						</div>
						...
						<ul class="nav navbar-nav navbar-right">
							<li class=""><a href="javascript:;"
								...
								<ul class="dropdown-menu dropdown-usermenu pull-right">
									<li><a
										href="${pageContext.request.contextPath }/empLogout.html"><i
