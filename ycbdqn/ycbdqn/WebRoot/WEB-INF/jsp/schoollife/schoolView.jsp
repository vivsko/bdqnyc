  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      ...
      <div class="x_content1">
        <form method="post" action="${pageContext.request.contextPath}/schoollife/sys/schoollifelist.html">
          <div class="item form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="textarea">主要内容 <span class="required">*</span>
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12">${schoollife.content}</div>
          </div>
